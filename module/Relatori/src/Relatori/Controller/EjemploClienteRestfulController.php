...
class EjemploClienteRestfulController extends AbstractActionController {
    ...
    public function indexAction() {
        ...
        $client->setUri('http://localhost:8888/skilla/public/relatori/rest/ejemplo-servidor-restful');
        ...
        switch ($method) {
            ...
            case 'login' :
                ...
                $client->setMethod('POST');
                    ...
                    $client->setParameterPOST(array('data' => $login));
                break;
            ...
            case 'update' :
                ...
                $adapter->connect('localhost', 8888);
